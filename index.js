document.addEventListener('DOMContentLoaded', function () {
    ...
    viewResumeIcon.addEventListener("click", function() {
        window.open('assets/Resume/Digbijaya_Biswal_Resume_4years.pdf', '_blank');
    });
...
downloadBtn.addEventListener('click', function() {
  ...
  link.href = 'assets/Resume/Digbijaya_Biswal_Resume_4years.pdf';
  link.download = 'Digbijaya_Biswal_Resume_4years.pdf';
...
function toggleJob(jobTitle) {
  const jobDescription = (jobTitle == 'tfsswe2') ? 
    document.getElementById('jobDescOne') : (jobTitle == 'lnswe2') ?
    document.getElementById('lnjobDesc') :
    document.getElementById('jobDescTwo');
  const jobElement = (jobTitle == 'tfsswe2') ?
    document.getElementById('job-one') :
    (jobTitle == 'lnswe2') ?
    document.getElementById('ln-job-one') :
